...
$getusersettings = mysql_query("SELECT `user`, `password`, `email`, `salt` FROM `Users` WHERE `id` = \"" . $_SESSION["luna_user"] . "\"");
...
<a class="navbar-brand visible-xs" href="index.php">ModernCount</a>
</div>
